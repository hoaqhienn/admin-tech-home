...
const ComplaintDataGrid2: React.FC<DataGridProps> = ({ onDelete, onBulkDelete, onStatusUpdate }) => {
  ...
  return (
    <Paper sx={{ height: '100%', width: '100%' }}>
      <DataGrid
        loading={isLoading}
        rows={complaints.filter(complaint => complaint.complaintStatus === 'In Progress')}
        columns={columns}
...
export default ComplaintDataGrid2;
